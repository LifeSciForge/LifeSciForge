...
| RAG & LLM Engineering | LangChain · ChromaDB · LangSmith · Ragas |
| Multi-Agent Systems | LangGraph · Pydantic · FastAPI · Redis |
| Cloud & Analytics | AWS S3 · Lambda · SageMaker · QuickSight · Power BI |
| CRM Intelligence | Salesforce · HubSpot · Dynamics 365 · scikit-learn |
...
| # | Project | Stack | Status |
|---|---|---|---|
| 05 | Pharma Evidence RAG System | LangChain · ChromaDB · LangSmith · Ragas | 🔲 Upcoming |
| 06 | Multi-Agent Pharma Intelligence System | LangGraph · Claude API · Redis | 🔲 Upcoming |

### 🔲 Phase 4 — Cloud & Analytics Engineering
| # | Project | Stack | Status |
|---|---|---|---|
...
`Apollo` `Clay` `ZoomInfo` `Power BI` `Tableau` `GA4` `Excel` `Gamma` `Notion`
